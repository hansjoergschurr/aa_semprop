...
feasability for the intended purpose. To test this a subset of the
ICCMA'15 dataset was used. The followin problem set were selected:
\texttt{testset4_st_small, testset5_st_medium, testset7_scc_small,
testset8_scc_medium}.
