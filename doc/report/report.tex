...
%To futher investigate the effect of the base degree and the $\beta$ factor in Watts-Strogatz
%frameworks another experiment was conducted. This time the cycle propability was fixed to
%$0.66$ and frameworks for base degree $2$, $4$, $6$ and $\beta$ values $0.1$, $0.33$ and $0.66$
%were generated.
% Note: WS mit deg 4 und cycle prop 0.66 erzeugt viiiieeeele extensions
...
\begin{sidewaystable}
\begin{tabular}[h]{|c|r|l|l|l|l|r|r|r|r|l|r|r|r|r|} % 16
\hline
